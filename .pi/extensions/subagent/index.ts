...
import { registerTodoWriteTool } from "./tools/todo-write-tool.js";
...
export default function (pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		description: [
			...
			"The subagent makes decisions and documents assumptions - it does not ask the user for input.",
