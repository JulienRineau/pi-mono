...
- [ ] Skill or system prompt guidance on when to use fetch vs snippets (deferred to future iteration)
...
- Jina Reader returns empty content → return `"No content could be extracted from this page"`
...
3. Empty response → "No content could be extracted from this page"
4. Whitespace-only → "No content could be extracted from this page"
